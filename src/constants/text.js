export const TEXT = {
  ...
  QUIZ_TITLE_SUFFIX: "개념 진단",
  CHECK_ANSWER: "정답 확인",
  NEXT_QUESTION: "다음 문제",
  VIEW_RESULT: "결과 보기",

  FEEDBACK_CORRECT: "정답입니다",
  FEEDBACK_WRONG: "개념 점검이 필요합니다",

  RESULT_TITLE_SUFFIX: "학생 진단 결과",
  RESULT_REPORT_TITLE: "종합 평가",
  RESULT_ANALYSIS_TITLE: "개념별 분석",
  RESULT_STRONG_TITLE: "강점 개념",
  RESULT_WEAK_TITLE: "보완 필요 개념",

  HOME_BUTTON: "처음으로",
  RETRY_BUTTON: "다시 도전하기",
