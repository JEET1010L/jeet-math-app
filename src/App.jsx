...
const styles = {
  ...
  card: { background: '#fff', padding: '25px', borderRadius: '25px', boxShadow: '0 10px 25px rgba(0,0,0,0.05)', border: '1px solid #E2E8F0' },
  ...
  nameInput: { width: '100%', padding: '16px', marginBottom: '20px', borderRadius: '12px', border: '1px solid #E2E8F0', boxSizing: 'border-box', fontSize: '16px', textAlign: 'center', outline: 'none', backgroundColor: '#F8FAFC' },
